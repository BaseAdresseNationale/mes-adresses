...
export function recoverBAL(email) {
...
export function isBalAlreadyPublished(codeCommune, userEmail) {
  return request(`/bases-locales/is-published?codeCommune=${codeCommune}&userEmail=${userEmail}`)
}
