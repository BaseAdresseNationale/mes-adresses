...
export function getVoies(balId, isDeleted = false) {
  return request(`/bases-locales/${balId}/voies?isdeleted=${isDeleted}`)
}
...
export function getToponymes(balId, isDeleted = false) {
  return request(`/bases-locales/${balId}/toponymes?isdeleted=${isDeleted}`)
}
