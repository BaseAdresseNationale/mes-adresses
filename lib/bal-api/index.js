...
export async function getBasesLocalesCreationStats() {
  return request('/stats/creations')
}
...
export function getVoiesDeleted(balId) {
  return request(`/bases-locales/${balId}/voies-deleted`)
}
...
export function getToponymesDeleted(balId) {
  return request(`/bases-locales/${balId}/toponymes-deleted`)
}
