...
import {Pane, Button, Heading, PlusIcon, Spinner, Alert, Text, SwapHorizontalIcon} from 'evergreen-ui'
  ...
  return (
    <Main>
      ...
      >
        ...
        <Pane>
          <Button iconBefore={SwapHorizontalIcon} marginX={8} marginY={4} onClick={() => {
      ...
      <Alert margin={16} hasIcon={false}>
        <Pane display='flex' justifyContent='center' flexDirection='column' alignItems='center'>
          ...
          <Button appearance='primary' is={Link} href='/new?demo=1'>Cliquer ici</Button>
        </Pane>
      </Alert>
    </Main>
  )
