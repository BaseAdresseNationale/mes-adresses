...
const importOptions = [
  { label: "Depuis la Base Adresse Nationale", value: "ban" },
  { label: "Depuis un fichier CSV", value: "file" },
  { label: "Créer une Base Adresse Locale vide", value: "empty" },
];
...
function NewPage({
  ...
  const steps = useMemo(() => {
    return [
      { label: "Choix de la commune", canBrowseNext: Boolean(commune) },
      {
