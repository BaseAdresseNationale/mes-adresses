        ...
        {toponyme => (
          <TableRow
            ...
            notifications={{
              ...
              isCertified: toponyme.isAllCertified,
              certificationContent: toponyme.isAllCertified ? 'Toutes les adresses de ce toponyme sont certifiées par la commune' : null
            }}
            actions={{
