...
interface FranceConnectProps {
  isDisabled?: boolean;
  handleStrategy: () => void;
}

function FranceConnect({ isDisabled, handleStrategy }: FranceConnectProps) {
  return (
    <>
      <Pane>
        ...
        <Pane
          ...
          onClick={isDisabled ? null : handleStrategy}
        >
          <NextImage
            width={280}
            height={72}
        ...
        <>
          <Pane>
            ...
            <UnorderedList textAlign="left">
              ...
              <ListItem>
                Vous serez automatiquement reconnu(e) comme{" "}
                <Strong>élu(e)</Strong> (maire, adjoint(e) ou conseiller(e)) de{" "}
                <Strong>votre commune</Strong>.
              </ListItem>
              <ListItem>
                Vous aurez la possibilité de vous identifier via{" "}
                <Strong>le service de votre choix</Strong> (impots.gouv.fr,
                ameli.fr etc...).
              </ListItem>
            </UnorderedList>
          </Pane>
          ...
          <Text textDecoration="underline">
            <Strong>
              Aucune donnée personnelle ne nous sera transmise durant ce
