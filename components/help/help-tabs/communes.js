...
const before = (
  <Paragraph marginTop='default'>
    Affichez la liste des communes de votre BAL en cliquant sur le nom de celle-ci se trouvant en
  ...
  return (
    <Pane>
      <Tuto title='Ajouter une commune'>
        ...
        <Tuto title='Bon à savoir'>
          <ListItem listStyleType='none'>
            ...
            Locales. L’ajout d’une commune n’est possible que si aucune commune n’est renseignée.
          </ListItem>
        </Tuto>
      </Tuto>
      ...
      <Tuto title='Consulter une commune'>
        ...
        <OrderedList margin={8}>
          <ListItem>
            Cliquez sur le bouton <Button iconBefore={MoreIcon} appearance='minimal' /> se situant à
            droite du nom de la commune
          </ListItem>
          <ListItem>
