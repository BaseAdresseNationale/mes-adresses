    ...
    <Pane>
      <Tuto title='Créer une nouvelle Base Adresse Locale'>
        ...
        <OrderedList margin={8}>
          ...
          <ListItem>
            Indiquez l’adresse email de votre mairie ou de l’administrateur de la Base Adresse
            Locale. C’est cette adresse qui recevra le lien permettant d’accèder à l’édition de
            votre Base Adresse Locale.
          </ListItem>
          <ListItem>
            Recherchez votre commune puis sélectionnez la dans la liste des suggestions.
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            ...
            <Button marginX={4} appearance='primary' intent='success' iconAfter={PlusIcon}>
      ...
      <Tuto title='Importer une Base Adresse Locale'>
        ...
        <OrderedList margin={8}>
          <ListItem>
            Sélectionnez ou déposez votre fichier au format <b>csv</b>. Attention ce fichier ne doit
            pas dépasser 10 Mo.
          </ListItem>
          <ListItem>
            Indiquez le nom de votre Base Adresse Locale dans le champ{' '}
      ...
      <Tuto title='Administrer votre Base Adresse Locale'>
        <Paragraph marginTop='default'>
          Accédez aux paramètres de votre Base Adresse Locale en cliquant sur l’icône{' '}
          <span>
            <CogIcon marginX={4} icon={CogIcon} />
          </span>{' '}
      ...
      <Problems>
        ...
        <Tuto title='Je ne trouve pas ma commune'>
          <Paragraph marginTop='default'>
            Si votre commune est une nouvelle commune issue d’une fusion, alors il est possible
            qu’elle n’apparaisse pas dans la liste des propositions. Si c’est votre cas, vous pouvez
            nous contacter sur <a href='mailto:adresse@data.gouv.fr'>adresse@data.gouv.fr</a>
          </Paragraph>
        </Tuto>
