  ...
  return (
    <Pane borderBottom padding={16} backgroundColor='white' display='flex' justifyContent='space-between' alignItems='center' flexShrink='0' width='100%' maxHeight={76}>
      ...
      <Pane display='flex' justifyContent='space-around' alignItems='center'>
        ...
        <Button is='a' href={PEERTUBE_LINK} target='_blank' appearance='minimal' marginRight='12px' minHeight='55px' iconAfter={VideoIcon}>
          Tutoriels vidéos
        </Button>

        <Button is='a' href='https://adresse.data.gouv.fr/guides' target='_blank' appearance='minimal' marginRight='12px' minHeight='55px' iconAfter={BookIcon}>
