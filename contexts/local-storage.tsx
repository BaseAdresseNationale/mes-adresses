...
const LocalStorageContext = React.createContext<LocalStorageContextType | null>(null)
...
export function LocalStorageContextProvider(props: LocalStorageContextProviderProps) {
  ...
  const [hiddenBal, , getHiddenBal, addHiddenBal, removeHiddenBal] = useLocalStorage(VISIBILITY_KEY)
